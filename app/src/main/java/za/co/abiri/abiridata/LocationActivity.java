...
public class LocationActivity extends AppCompatActivity {
    ...
    TextView popupTitle,popupDescription,latitudeTextView,textLat,textLong;
    //Button getlocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        popupAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                && !textLat.getText().toString().isEmpty()
                && !textLong.getText().toString().isEmpty()
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    String lng = textLong.getText().toString();

                                    /*
                                    int convertedlat = Integer.parseInt(lat);
                                    int convertedlong = Integer.parseInt((lng));

                                     */

                                    float convertedlat = Float.parseFloat(lat);
                                    float convertedlong = Float.parseFloat(lng);
